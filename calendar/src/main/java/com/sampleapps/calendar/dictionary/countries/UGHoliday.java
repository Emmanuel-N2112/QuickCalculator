...
public class UGHoliday extends HolidayDictionary {
    ...
    protected List<CHoliday> populateStaticNationalHolidays() {
        ...
        holidays.add(addHoliday(HolidayNames.VALENTINE, HolidayTypes.NATIONAL, UGHolidayDate.getValentineDay(getYear())));
        holidays.add(addHoliday(HolidayNames.WOMEN_DAY, HolidayTypes.NATIONAL, UGHolidayDate.getWomenDay(getYear())));
        holidays.add(addHoliday(HolidayNames.GOOD_FRIDAY, HolidayTypes.NATIONAL, UGHolidayDate.getGoodFriday(getYear())));
    ...
    protected List<CHoliday> populateDynamicNationalHolidays() {
        ...
        holidays.add(addHoliday(HolidayNames.MOTHER_DAY, HolidayTypes.OBSERVANCE, getDynamicHoliday(getYear(), Month.MAY, 2, DayOfWeek.SUNDAY)));

        // Father's Day - 3rd Wednesday in June
        holidays.add(addHoliday(HolidayNames.FATHER_DAY, HolidayTypes.OBSERVANCE, getDynamicHoliday(getYear(), Month.JUNE, 3, DayOfWeek.WEDNESDAY)));
